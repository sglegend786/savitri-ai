        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            ...
            <Link href="/" className="flex items-center gap-2.5 shrink-0">
              <div className="w-9 h-9 rounded-xl bg-[#1a2b6b] flex items-center justify-center text-white font-black text-xl">S</div>
              <div>
                <span className="text-lg font-black text-[#1a2b6b] tracking-tight">SAVIX</span>
                <span className="text-lg font-black text-[#4A7BFF] tracking-tight">-AI</span>
              </div>
            </Link>
